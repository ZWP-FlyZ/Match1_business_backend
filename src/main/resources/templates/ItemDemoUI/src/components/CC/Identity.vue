...
<!-- 全局div开始 -->
	<div>
		<div class="delete-modal-dialog identity-modal">
			...
			<div class="delete-modal-header"><span class = "identity-header">已有业务身份</span></div>
				<div class="delete-modal-body">
					<div class="delete-modal-delete-confirm">
						<div class = "identity-list">
							<span class="icon-android"></span>
							<span>业务身份1</span>
							<router-link to="/cCprocess" class = "link-btn link-btn-primary identity-button-edit">编辑</router-link>
						</div>
						<div class = "identity-list">
							<span class="icon-android"></span>
							<span>业务身份2</span>
						...
						<router-link to="/cCprocess" class = "link-btn link-btn-blue identity-new">新建业务身份</router-link>
					</div>
				</div>
				<div class = "delete-modal-footer">
					...
					<button class = "link-btn link-btn-red">取消</button>
				</div>
			</div>
		</div>
	</div>	
...
<style>
	...
	.identity-button-edit{margin-left: 100px;}
	.identity-list{margin-bottom: 20px;}
	.identity-new{margin-left: 75px;}
