  ...
  <div class=" regisiterpage">
    ...
    <div class="items">
      <form  class="itemsform">
        <div class="item">
          <label class="nameid">流程名称: </label><input type="text" class="inputbox checkView basic-inputbox lookUp-input gm-input" disabled="disabled" value="淘宝女装T-shirt商品发布">
        </div>
         <div class="item">
        ...
        <div class="item">
          ...
          <select class="inputbox checkView SelectList basic-select  lookUp-input basic-inputbox gm-input" disabled="disabled">
            <option >商品发布</option>
    ...
    <br/>
    <div class="bottom" >
      <router-link to="/identityDetail"  class="ok link-btn link-btn-default">关闭</router-link>
    </div>
    <br/>
  </div>
</template>
