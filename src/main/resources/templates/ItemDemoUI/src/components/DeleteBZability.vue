<template>
	<div class = "deleteBZability">
	<div id = "nav">
		<div class = "deleteBZability-header">
			<p>删除确认</p>
			<!-- <a href=""><router-link to="/bzability">X</router-link></a> -->
			<router-link to="/bzability"><img src="../assets/img/delete.png" alt="" class = "BZability-delete"></router-link>
		</div>
...
<style>
	...
	.deleteBZability-header{
		background: #0099FF;
		height: 45px;
		font-size: 30px;
		color: #fff;
	}
	.deleteBZability-header p{
		padding-left: 5%;
		float: left;
		margin-right: 55%;
	}
